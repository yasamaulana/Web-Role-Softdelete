<x-maz-sidebar :href="route('dashboard')" :logo="asset('images/logo/logo.svg')">
    ...
    <x-maz-sidebar-submenu name="User Management" icon="bi bi-grid-fill">
        <x-maz-sidebar-submenu-item name="Users" :link="route('users.home')"></x-maz-sidebar-submenu-item>
        @if (Auth::user()->role == 'admin')
            <x-maz-sidebar-submenu-item name="Users Api" :link="route('users.api')"></x-maz-sidebar-submenu-item>
        @endif
